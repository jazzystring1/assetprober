try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("sdk.Cookie", ["QueryString", "sdk.Runtime", "sdk.Scribe", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    g.getDomain = b;
                    g.loadMeta = e;
                    g.loadSignedRequest = f;
                    g.setSignedRequestCookie = l;
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1005095505","namespace":"FB","message":"' + e.message + '"}}');
